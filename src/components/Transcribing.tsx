const Transcribing = ({ downloading }: { downloading: boolean }) => {
  return (
    <div className='flex flex-col items-center justify-center flex-1 text-center gap-10 md:gap-14 pb-24 p-4'>
